 ...
 * @author Cristopher
 */
public class AuctionClientHelpers {
    ...
    public static SecretKey generateSymmetricKey() {
        try {
            ...
            Logger.getLogger(AuctionClientHelpers.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
    ...
    //Decifrar a mensagem utilizando a chave assimétrica (AES)
